...
async function main() {
  ...
  row.querySelector('.ln-catalog').value = String(prodId);
  row.querySelector('.ln-catalog').dispatchEvent(new win.Event('change'));
  await wait(10);
  row.querySelector('.ln-desc').value = 'Submersible Pump 1.5kW';
  row.querySelector('.ln-desc').dispatchEvent(new win.Event('input'));
  row.querySelector('.ln-qty').value = '15';
  row.querySelector('.ln-qty').dispatchEvent(new win.Event('input'));
  row.querySelector('.ln-price').value = '4000';
